...
print("\nObservation:")
print("A long process executes first, causing shorter processes to wait.")
print("This is called the Convoy Effect.")
...
ax.set_yticks([])
ax.set_xticks(times)
ax.set_title("FCFS Gantt Chart (Convoy Effect)")
